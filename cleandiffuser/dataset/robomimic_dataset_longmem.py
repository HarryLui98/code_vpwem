...
from cleandiffuser.dataset.dataset_utils import LongMemSequenceSampler, EmptyNormalizer, RotationTransformer, dict_apply, \
...
class LongMemRobomimicImageDataset(BaseDataset):
    def __init__(self,
                 dataset_dir,
                 shape_meta: dict,
                 n_obs_steps=None,
        ...
        self.sampler = LongMemSequenceSampler(
            ...
            maximum_memory_length=maximum_memory_length,
        )
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        obs_dict['ep_step'] = sample['ep_step'].astype(np.int32)
