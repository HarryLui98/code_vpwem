...
class MomartImageWrapper(gym.Env):
    def __init__(self, 
        env: EnvGibsonMOMART,
        shape_meta: dict,
        ...
        # self.action_space = env.env.action_space
    ...
    def step(self, action):
        ...
        obs = self.get_observation(raw_obs)
        info['sc'] = self.env.env.check_success()
