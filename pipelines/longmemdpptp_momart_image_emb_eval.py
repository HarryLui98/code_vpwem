...
@hydra.main(config_path="../configs/dp/momart/chi_transformer_ptp_longmem", config_name="momart_emb_eval")
def pipeline(args):
    # ---------------- Create Logger ----------------
    set_seed(args.seed)
    ...
    # save results
    result_path = os.path.join(args.work_dir, f"result_ckpt{ckpt}_{args.inference_action_steps}.npy")
