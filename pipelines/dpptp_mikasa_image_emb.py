...
from cleandiffuser.dataset.mikasa_emb_dataset import MikasaEmbDataset
...
@hydra.main(config_path="../configs/dp/mikasa/chi_transformer_ptp", config_name="shell_game_touch_emb")
def pipeline(args):
    # ---------------- Create Logger ----------------
    set_seed(args.seed)
    ...
    dataset = MikasaEmbDataset(dataset_path, horizon=args.horizon, shape_meta=args.shape_meta,
