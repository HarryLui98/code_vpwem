...
@hydra.main(config_path="../configs/dp/mikasa/chi_transformer", config_name="shell_game_touch")
def pipeline(args):
    # ---------------- Create Logger ----------------
    set_seed(args.seed)
    ...
    # print(dataset)
    normalizer_loaded = dataset.normalizer
    ...
    result = inference(args, envs, normalizer_loaded, agent)
